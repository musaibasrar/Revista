...
-->
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="250" align="center" valign="middle"><p class="style1"> Registration Sucessful</p>
        <p class="style1">
          
            <input type="button" id="view" value="View All " onClick="ViewAll()">
            <input type="button" value="Add New" id="addnew" onClick="JavaScript:window.location='addExecutive.jsp';">
        </p></td>
      </tr>
    </table>
            </form>
