                ...
                <main>
                	<form id="form1" method="post">
		              <table align="center">
		                ...
		                <td height="20"><p> <br><br></p></td>
		                
		                <tr>
		
		                    <td height="10" style="font-weight: Bold;">Enter File Name &nbsp;&nbsp;&nbsp;&nbsp;
		                            <label>
		                                <input name="filename" type="text" class="textField" id="filename" size="26"  >
		                            </label>
		                        </p> </td>
		                </tr>
		                ...
		                <tr>
		                    ...
		                    <td><p>&nbsp;&nbsp;&nbsp;&nbsp; </p>
		                        <p>
		                        	...
		                        	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                            <input type="button" id="view" class="btn btn-success" value="Backup" onClick="Backup()">
