...
<html >
    <head >
     <%
        ...
        <title>Add Subscriber Credit</title>
    ...
    <body class="sb-nav-fixed">
                ...
                <div id="tabs">
                	<br>
                    	<ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Credit Subscriber's Form</li>
                        </ol>
                    ...
                    <div>
                        <table width="80%" border="0" align="center">
                            ...
                            <tr>
                                <td>
                                    <label>
                                        <input name="creditsubscriber" type="hidden" value="1" class="textField" id="creditsubscriber"  >
                                    </label>
                                    <br/>
                                </td>
                            </tr>
        ...
        <script type="text/javascript">
            ...
            function addContact() {
                ...
                form1.action = "Controller?process=PersonalProcess&action=AddContactCreditS";
                form1.submit();
            }
