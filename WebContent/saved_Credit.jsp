...
<html >
    <head >
     <%
        ...
        <title>Credit Subscriber Saved</title>
                	...
                	<form id="form1" method="post">
    					<table class="newsubscriber">
     						 <tr>
        						<td>
        							<br><br><br><br>
        							<p style="color: green;">Credit Subscriber has been added successful</p>
        					    </td>
      						</tr>
      						 <tr>
        						...
        						<td align="center">
            							...
            							<input type="button" value="Add New" id="addnew" class="btn btn btn-warning" onClick="JavaScript:window.location='Controller?process=PersonalProcess&action=addSubscriberCredit';">
        					    </td>
      						</tr>
    					</table>
            		</form>
