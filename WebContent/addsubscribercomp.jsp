<%-- 
    Document   : addsubscribercomplimentary
...
<html >
    <head >
     <%
        ...
        <title>Add Subscriber Complimentary</title>
    ...
    <body class="sb-nav-fixed">
                ...
                <div id="tabs">
                	<br>
                    	<ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Complementary Subscriber's Form</li>
                        </ol>
                    ...
                    <div>
                        <table width="80%" border="0" align="center">
                            ...
                            <tr>
                                <td>
                                    <label>
                                        <input name="complsubscriber" type="hidden" value="1" class="textField" id="complsubscriber"  >
                                    </label>
                                    <br/>
                                </td>
                            </tr>
                            ...
                            <tr>
								...
								<td><input name="name" type="text" class="myclass" id="name" size="26" onblur="validateName();"  onkeyup="check(this.value);"></td>
                                <td class="rowclass" >Contact Number &nbsp;</td> 
                                    <td> <input name="contactNO" type="text" class="textField" id="contactno" size="26" minlength="10" maxlength="10" onblur="checkmobile(this.value);" onkeypress="return validateContactNum(this);" >
                                 </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="rowclass" >Co-Contact No. &nbsp;  </td>
                                     <td>   <input name="cocontactnumber" type="text" class="textField" id="cocontactnumber" minlength="10" maxlength="10" size="26" onclick="validateNameContact();" >
                                </td>

                                <td class="rowclass" >E-mail &nbsp;   </td>
                                     <td>
                                     <input name="email" type="email" class="textField" id="email" size="26" onclick="validateNameContact();" >
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="rowclass" >Created Date &nbsp;</td>
                                     <td>
                                     <input name="createddate" type="date" value="<%= df.format(new java.util.Date())%>" style="width:260px;"  data-validate="validate(required)" >
                                </td>
                            </tr>
                            ...
                            <tr>
                               ...
                               <td class="rowclass" >City &nbsp;  </td>
                                ...
                                <td>
                                    ...
                                    <label>
                                        <input name="addcity" type="text" style="display: none;" class="myclass" id="addcity" size="26" maxlength="20"  >
                                    </label>
                                </td>
                                
                                <td class="rowclass" >Pincode &nbsp;</td>
                                     <td><input name="pincode" type="text" class="textField" id="pincode" size="26" onblur="validateNameContact();" onkeypress="return validateContactNum(this);" >
                                </td>
                            </tr>
                           ...
                           <!-- <tr>
                            ...
                            <tr>
                                ...
                                <td class="rowclass" >From Issue No. &nbsp;</td>
                                     <td> <input name="fromkmissueno" type="text" class="textField" id="fromkmissueno" size="26" onblur="noofissues();" onkeyup="return calculateIssues()" >
                                </td>



                                <td class="rowclass" >To Issues No. &nbsp;</td>
                                     <td><input name="tokmissueno" type="text" class="textField" id="tokmissueno" size="26" onblur="noofissues();" onfocus="return calculateIssues()"  >
                                </td>
                            </tr>
                        ...
                        <!--    <tr>
                            ...
                            <div>
                                <table width="100%" >
                                    ...
                                    <tr>
                                        <td align="center">
                                            <button id="save" class="btn btn-info" onmouseover="validateNameContact();">Save</button>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <script type="text/javascript">
		        ...
		        function addContact(){
		            ...
		            form1.action="Controller?process=PersonalProcess&action=complimentarysubscriber";
		            form1.submit();
		        }
