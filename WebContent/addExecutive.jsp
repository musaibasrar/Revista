                ...
                <div id="tabs">
                	<br>
                    	<ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Executive's Form</li>
                        </ol>
                        ...
                        <table width="80%" border="0" align="center">
                            ...
                            <tr>
                                ...
                                <td class="rowclass" >Address &nbsp;  </td>
                                     <td>   
                                     <input name="address" type="text" class="textField" id="addressline1" size="26"  onclick="validateNameContact();" >
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="rowclass" >Joining Date &nbsp;</td>
                                     <td>
                                     <input name="joiningdate" type="date" value="<%= df.format(new java.util.Date())%>" style="width:260px;"  data-validate="validate(required)" >
                                </td>
                                
                                <td class="rowclass">Remarks &nbsp;
                                </td>
                                <td>
                                    <input name="remarks" type="text" class="textField" id="remarks" size="26" onclick="validateNameContact();" >
                                </td>
                            </tr>
