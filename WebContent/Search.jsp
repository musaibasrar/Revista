...
<html >
    <head >
        ...
        <script type="text/javascript">
            ...
            function back(){
                 ...
                 document.location.href="viewAll.jsp";
    ...
    <body onload="rediredt()"  >

        <form name="form1" action="Controller?process=PersonalProcess&action=archiveMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Subscribers   </td>
                        
                        <td class="headerTD" width="25"><input type="button" style="height:15px;width: 15px;background-image: url(images/backbutton.jpg); " id="goback"  onclick="back();" ></td>
                        <td class="headerTD" width="25"><input type="button" style="height:15px;width: 15px;background-image: url(images/re12.png); " id="refresh"  onclick="testonload();" ></td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tbody>
                        <c:forEach items="${PersonalDetailsListAdvance}" var="Personal">
