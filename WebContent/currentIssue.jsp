                ...
                <main>
		               <form id="form1" method="post" action="Controller?process=CurrentIssueProcess&action=addIssue">
				            ...
				            <table align="center">
				                <tr>
				                    <td><br><br>
				                    <p>Enter the current issue number*: <input name="issue" type="text" class="textField" id="issue" size="10" onblur="validateName();"> </p>
				                        <br>
				                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                            <input class="btn btn-success" type="submit" id="ok" value="OK" onmouseover="validateIssue()" >
				                    </td>
