                	...
                	<form id="form1"  method="post">
    					<table class="newsubscriber">
     						 <tr>
        						<td>
        							<br><br><br><br>
        							<p style="color: red;"> Executive can't be added<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Please try again</p>
        					    </td>
      						</tr>
      						 <tr>
        						...
        						<td align="center">
            							...
            							<input type="submit" value="Add New" id="addnew" class="btn btn btn-warning" onClick="JavaScript:window.location='addExecutive.jsp';">
        					    </td>
      						</tr>
    					</table>
            		</form>
