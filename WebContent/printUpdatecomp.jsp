...
<html >
    <head >
     <%
        ...
        <title>Confirm Dispatch of Complimentary Subscribers</title>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                  Confirm Dispatch of Complimentary Subscribers
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <button value="dispatched" class="btn btn-success" type="submit" id="delete"><i class="far fa-check-square"></i></i>&nbsp;Dispatched</button> 
                                </div>
                            </div>
                        </div>
                    </div>
