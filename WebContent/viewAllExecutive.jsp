...
<html >
    <head >
     <%
        ...
        <title>View All Executive</title>
                                	...
                                	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                        					<c:forEach items="${ExecutiveListAll}" var="Executive">
	                                            <tr>
	                                            	<td class="active">
	            									<input type="checkbox" id="<c:out value="${Executive.eid}"/>"  value="<c:out value="${Executive.eid}"/>" class="select-item checkbox" name="executiveIDs" name="select-item"  />
											        </td>
	                                                <td><a style="color: black;font-weight:bold;text-decoration: none;background-color: transparent;"  href="Controller?process=ExecutiveProcess&action=viewDetails&id=<c:out value='${Executive.eid}'/>"><c:out value="${Executive.name}"/></a></td>
	                                                <td><c:out value="${Executive.contactnumber}"/></td>
	                                                <td><c:out value="${Executive.email}"/></td>
	                                            </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                                    <button value="Delete" class="btn btn-danger" type="submit" id="delete"><i class="fas fa-trash"></i>&nbsp;Delete</button> 
                                </div>
                            </div>
                        </div>
                    </div>
