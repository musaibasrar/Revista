        ...
        <script type="text/javascript">
            ...
            function deleteRecords(){
                var form1=document.getElementById("form1");
                 form1.action="Controller?process=PersonalProcess&action=deleteMultiple";
                form1.submit();
            }
            
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="Controller?process=PersonalProcess&action=restore";
                form1.submit();
            }
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                View All Archive<input type="hidden" name="hiddenChest" value="subscriber" id="hiddenChest"/>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                	...
                                	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                        					<c:forEach items="${PersonalDetailsListArchive}" var="Personal">
                                            <tr>
                                            	<td class="active">
                                                ...
                                                <td><c:out  value="${Personal.createddate}"/></td>
                                            </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                                    <button value="Restore" class="btn btn-success" type="submit" onclick="restoreRecords();" id="restore"><i class="fas fa-trash-restore"></i>&nbsp;Restore</button>
                                    <button value="delete" class="btn btn-danger" type="submit" onclick="deleteRecords();" id="delete"><i class="fas fa-trash"></i>&nbsp;&nbsp;&nbsp;Delete</button> 
                                </div>
                            </div>
                        </div>
                    </div>
