<%-- 
    Document   : PrintAllComplimentarysubscriber
...
<html >
    <head >
     <%
        ...
        <title>Complimentary Subscribers</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                <form name="form1" id="form1"action="Controller?process=PersonalProcess&action=printpreviewCS" method="post">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                	...
                                	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                        					<c:forEach items="${PersonalDetailsListForPrintCS}" var="Personal">
                                            <tr>
                                            	<td class="active">
                                    ...
                                    <button value="print" class="btn btn-warning" type="submit" id="delete"><i class="fas fa-print"></i>&nbsp;Print Preview</button> 
                                </div>
                            </div>
                        </div>
                    </div>
