    ...
    <body  >
        ...
        <form name="form1" id="form1"action="Controller?process=PersonalProcess&action=archiveMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Credit Subscribers<input type="hidden" name="hiddenChest" value="creditsubscriber" id="hiddenChest"/></td>
                    </tr>
                    ...
                    <tbody>
                        <c:forEach items="${PersonalDetailsList}" var="Personal">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="Controller?process=PersonalProcess&action=viewDetailsCreditS&id=<c:out value='${Personal.pid}'/>"><c:out value="${Personal.name}"/></a></td>
