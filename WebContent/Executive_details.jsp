                ...
                <div id="tabs">
                	<br>
                    	<ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Executive's Details</li>
                        </ol>
                    ...
                    <div>
                        <table width="80%" border="0" align="center">
                            ...
                            <tr>
								...
								<td class="subscriberdetails"><c:out value="${executiveDetails.name}" /></td>
                                <td class="rowclass" >Contact Number: &nbsp;</td> 
                                    <td  class="subscriberdetails"> <c:out default="" value="${executiveDetails.contactnumber}" />
                                 </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="rowclass" >Address: &nbsp;  </td>
                                     <td  class="subscriberdetails">   <c:out value="${executiveDetails.address}" />
                                </td>
                            </tr>
							...
							<tr>
                                <td class="rowclass" >Joining Date: &nbsp;</td>
                                     <td  class="subscriberdetails">  <c:out default="" value="${executiveDetails.joiningdate}" />
                                </td>
                                
                                <td class="rowclass" >Remarks: &nbsp;</td>
                                     <td  class="subscriberdetails"><c:out default="" value="${executiveDetails.remarks}" />
                                </td>
                            </tr>
