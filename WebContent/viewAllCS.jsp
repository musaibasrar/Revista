<%-- 
    Document   : viewAllComplimentarySubscribers
...
<html >
    <head >
     <%
        ...
        <title>View All Complimentary Subscribers</title>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                 <form name="form1" action="Controller?process=PersonalProcess&action=archiveMultiple" method="post">
                    <div class="container-fluid">
                    	<br>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table mr-1"></i>
                                View All Complementary Subscribers<input type="hidden" name="hiddenChest" value="complsubscriber" id="hiddenChest"/>
                            </div>
                            <div class="card-body">
                                	...
                                	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a style="color: black;font-weight:bold;text-decoration: none;background-color: transparent;"  href="Controller?process=PersonalProcess&action=viewDetailsCS&id=<c:out value='${Personal.pid}'/>"><c:out value="${Personal.name}"/></a></td>
