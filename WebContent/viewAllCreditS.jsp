<%-- 
    Document   : viewAllCreditSubscribers
...
<html >
    <head >
     <%
        ...
        <title>View All Credit Subscribers</title>
      ...
      <!--  <link href="https://cdn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css" rel="stylesheet" crossorigin="anonymous" />
        ...
        <script type="text/javascript">
        	...
        	function markPaid(){
				...
				var form1 = document.getElementById("form1");
					form1.action = "Controller?process=PersonalProcess&action=markPaid";
					form1.submit();
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                View All Credit Subscribers<input type="hidden" name="hiddenChest" value="creditsubscriber" id="hiddenChest"/>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                	...
                                	<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a style="color: black;font-weight:bold;text-decoration: none;background-color: transparent;"  href="Controller?process=PersonalProcess&action=viewDetailsCreditS&id=<c:out value='${Personal.pid}'/>"><c:out value="${Personal.name}"/></a></td>
                                    ...
                                    <button class="btn btn-success" id="paid"><i class="fas fa-check"></i>&nbsp;Paid</button>
