    ...
    <body  >
        ...
        <form name="form1" id="form1"action="Controller?process=PersonalProcess&action=archiveMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Expiring/Expired Subscribers</td>
                    </tr>
                    ...
                    <tbody>
                        <c:forEach items="${PersonalDetailsListExpire}" var="Personal">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a style="color:red"  class="dataTextInActive" href="Controller?process=PersonalProcess&action=viewDetails&id=<c:out value='${Personal.pid}'/>"><c:out value="${Personal.name}"/></a></td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="Controller?process=PersonalProcess&action=expire&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="Controller?process=PersonalProcess&action=expire&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="Controller?process=PersonalProcess&action=expire&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
