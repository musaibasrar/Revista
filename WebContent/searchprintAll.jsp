...
%>
        ...
        <script type="text/javascript">
            ...
            function redirect(){
                var form1=document.getElementById("form1");
                form1.action="Controller?process=PersonalProcess&action=redirectPrint";
                form1.submit();
    ...
    <body  >
        ...
        <form name="form1" id="form1"action="Controller?process=PersonalProcess&action=printpreview" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">Print All Subscribers</td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <thead>
                        <tr  >
                            ...
                            <th title="click to sort" class="headerText">Pincode&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th> 
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="Controller?process=PersonalProcess&action=viewAllconfirmPrint&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="Controller?process=PersonalProcess&action=print&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="Controller?process=PersonalProcess&action=print&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
