    ...
    <body  >
        ...
        <form name="form1" action="Controller?process=PersonalProcess&action=archiveMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Complementary subscribers <input type="hidden" name="hiddenChest" value="complsubscriber" id="hiddenChest"/></td>
                    ...
                    <tbody>
                        <c:forEach items="${PersonalDetailsList}" var="Personal">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="Controller?process=PersonalProcess&action=viewDetailsCS&id=<c:out value='${Personal.pid}'/>"><c:out value="${Personal.name}"/></a></td>
