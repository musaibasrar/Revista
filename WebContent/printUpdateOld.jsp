...
<html >
    ...
    <body >
        ...
        <form name="form1" id="form1"action="Controller?process=PersonalProcess&action=confirmPrint" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">Confirm Print</td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tbody>
                        <c:forEach items="${PersonalDetailsListConfirmPrint}" var="Personal">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataText"><c:out value="${Personal.name}"/></a></td>
                    ...
                    <tfoot><tr>
                            <td  class="footerTD" colspan="2" ><input value="Confirm" type="submit" id="delete"/> </td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="Controller?process=PersonalProcess&action=viewAllconfirmPrint&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="Controller?process=PersonalProcess&action=viewAllconfirmPrint&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
