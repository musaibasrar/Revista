                ...
                <table cellpadding="2"  border="0">
                    ...
                    <c:forEach begin="1" end="${endValue}">
                        ...
                        <tr>
                            ...
                            <td class="fontsize" ><textarea class="fontsize" rows="9" cols="35"  style="padding: 12px 20px;padding: 12px 20px;border: none;background-color: transparent;resize: none;outline: none;">To,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out default="" value="${currentissue.currentissue}" />-<%= request.getSession().getAttribute("personaltoissueno"+i+"") %>/<%= request.getSession().getAttribute("personalpid"+i+"") %>&#13;&#10;<%= request.getSession().getAttribute("personalName" + i + "")%>&#13;&#10;<%= request.getSession().getAttribute("personaladdressline1" + i + "")%>&#13;&#10;<%= request.getSession().getAttribute("personalstate" + i + "")%>&#13;&#10;<%= request.getSession().getAttribute("pincode" + i + "")%></textarea> </td>
                            </c:if>
                            <c:set var="limit" value="${limit+1}"/>
                            <% i = i + 1;%>
                            <c:if test="${limit < iInitial}">
                            <td  class="fontsize"><textarea class="fontsize" rows="9" cols="35" style="padding: 12px 20px;padding: 12px 20px;border-width: 0px;">To,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out default="" value="${currentissue.currentissue}" />-<%= request.getSession().getAttribute("personaltoissueno"+i+"") %>/<%= request.getSession().getAttribute("personalpid"+i+"") %>&#13;&#10;<%= request.getSession().getAttribute("personalName" + i + "")%>&#13;&#10;<%= request.getSession().getAttribute("personaladdressline1" + i + "")%>&#13;&#10;<%= request.getSession().getAttribute("personalstate" + i + "")%>&#13;&#10;<%= request.getSession().getAttribute("pincode" + i + "")%></textarea> </td>
                            </c:if>
                            <c:set var="limit" value="${limit+1}"/>
                            <% i = i + 1;%>
                            <c:if test="${limit < iInitial}">
